        ...
        $(this).each(function() {
            ...
            function insert()
            {
                ...
                if(videoID.length == 11) {
                    embed = '<iframe width="' + options.contentsWidth + '" height="' + options.contentsHeight + '" src="http://www.youtube.com/embed/' + videoID + '" frameborder="0" allowfullscreen></iframe>';
                } else if (!isNaN(videoID)) {
                    embed = '<iframe src="http://player.vimeo.com/video/' + videoID + '" width="' + options.contentsWidth + '" height="' + options.contentsHeight + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                }
