...
(function($) {
    var MdSliderPanel = function() {
        ...
        this.textBoxTemplate = '<div class="slider-item ui-widget-content item-text" data-top="0" data-left="0" data-width="100" data-height="50" data-borderstyle="solid" data-type="text" data-title="Text" style="width: 100px; height: 50px;"><p>Text</p><span class="sl-tl"></span><span class="sl-tr"></span><span class="sl-bl"></span><span class="sl-br"></span><span class="sl-top"></span><span class="sl-right"></span><span class="sl-bottom"></span><span class="sl-left"></span> </div>';
        ...
        this.initTab = function() {
            ...
            $('.panel-settings-link').live('click', function() {
                Drupal.media.popups.mediaBrowser(function (mediaFiles) {
                    ...
                    var settings = JSON.parse($('.settings input', self.activePanel).val());
                    var slid = $('input[name=slider_id]').val();
                    settings.fid = icon.fid;
                    $('.settings input', self.activePanel).val(JSON.stringify(settings));
                    $.post(location.protocol + '//' + location.host + Drupal.settings.basePath + '?q=admin/structure/md-slider/get-background-image', {fid: icon.fid, slider_id: slid}, function(response) {
                        $('.md-slide-image img', self.activePanel).attr('src', response);
                    });
                });
            });
            $('.custom-thumbnail-setting').live('click', function() {
                Drupal.media.popups.mediaBrowser(function (mediaFiles) {
                    var icon = mediaFiles[0];
                    var settings = JSON.parse($('.settings input', self.activePanel).val());
                    var slid = $('input[name=slider_id]').val();
                    settings.thumb_fid = icon.fid;
                    $('.settings input', self.activePanel).val(JSON.stringify(settings));
                });
            });
            /**
        ...
        this.setItemTitle = function(value) {
            if (this.selectedItem != null) {
                ...
                if($(this.selectedItem).data("type") == "text")
                    $(this.selectedItem).find("p").html(value.replace(/\n/g, "<br />"));
        ...
        this.setItemFontWeight = function(value) {
            if (this.selectedItem != null) {
                $(this.selectedItem).data("font-weight", value);
