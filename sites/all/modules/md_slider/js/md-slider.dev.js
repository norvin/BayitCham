...
(function ($) {
    effectsIn = ['rollIn', 'fadeIn', 'fadeInUp', 'fadeInDown', 'fadeInLeft', 'fadeInRight', 'fadeInRight', 'bounceIn', 'bounceInDown', 'bounceInUp', 'bounceInLeft', 'bounceInRight', 'rotateIn', 'rotateInDownLeft', 'rotateInDownRight', 'rotateInUpLeft', 'rotateInUpRight'];
    effectsOut = ['rollOut', 'fadeOut', 'fadeOutUp', 'fadeOutDown', 'fadeOutLeft', 'fadeOutRight', 'fadeOutRight', 'bounceOut', 'bounceOutDown', 'bounceOutUp', 'bounceOutLeft', 'bounceOutRight', 'rotateOut', 'rotateOutDownLeft', 'rotateOutDownRight', 'rotateOutUpLeft', 'rotateOutUpRight'];
    ...
    $.fn.mdSlider = function(options) {
        ...
        function initControl() {
            ...
            if(options.slideShow && options.showLoading) {
                var loadingDiv = $('<div class="loading-bar-hoz loading-bar-' + options.loadingPosition + '"><div class="md-loading-bg"></div><div class="md-loading-state"></div></div>');
                wrap.append(loadingDiv);
                loadingBar = $(".md-loading-state", loadingDiv);
            }
            // Border
        ...
        function initDrag() {
            if(hasTouch) {
                ...
                self.bind('touchend', function (event) {
                    event.preventDefault();
                    var originalEvent = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
                    touchstart = false;
        ...
        function slide(index, next) {
            ...
            if (index != activeIndex) {
                ...
                if (transitions) {
                    ...
                    activeIndex = index;
                    if (loadingBar) {
                        loadingBar.stop(true, true).width(0).animate({width: "100%"}, slideShowDelay);
                    }
                    if(playing) {
                        setTimer(slideShowDelay);
                    }
                }
            }
        ...
        function setTimer(slideShowDelay) {
            slideShowTimer = setTimeout(function() { slideShow() }, slideShowDelay);
        }
        function clearTimer() {
        ...
        function slideNext() {
            ...
            index++;
            index = index >= numItem ? 0 : index;
            slide(index, true);
        }
        function slidePrev() {
            var index = activeIndex;
            index--;
            index = index < 0 ? numItem - 1 : index;
            slide(index, false);
        }
