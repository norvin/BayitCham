...
(function($) {
    var MdSliderToolbar = function(panel) {
        ...
        this.changeFontWeightOption = function(fontweight) {
			...
			var oldoption = $("#md-toolbar select.mdt-font-weight").val();
            if(fontweight) {
        ...
        this.changeToolbarValue = function() {
            if (this.selectedItem != null) {
                var itemValues = $.extend({
                    ...
                    opacity: "",
                    style: ""
                }, this.selectedItem.getItemValues());
                ...
                itemValues.backgroundcolor ? $("a.mdt-background-color", "#md-toolbar").css("backgroundColor", "#" + itemValues.backgroundcolor) : $("a.mdt-background-color", "#md-toolbar").css("backgroundColor", "");
